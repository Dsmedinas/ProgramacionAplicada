...
class Operaciones:               # Creamos una clase llamada Calculator que agrupará todas las funciones de la calculadora
    ...
    def restar(self, a, b):          #Recibe dos números (a y b) y devuelve su suma
        return a - b            #resta los parámetros y devuelve el resultado

    def multiplicar(self, a, b):           #Recibe dos números (a y b) y devuelve su suma
    ...
    def modulo(self, a, b):         #Devuelve el resto de la división (a % b)
