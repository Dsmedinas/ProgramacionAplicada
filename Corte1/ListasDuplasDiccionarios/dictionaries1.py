...
#numero_camaras = {"backyard": 6,  "garage": 2, "driveway": 1}

#Imprime los diccionarios sensores,numero camaras y translations
'''print(sensores)
print(numero_camaras)
translations = {"mountain": "orod", "bread": "bass", "friend": "mellon", "horse": "roch" }
print(translations) '''

#Verificando un error
powers = {[1, 2, 4, 8, 16]: 2, [1, 3, 9, 27, 81]: 3} #El problema es que está intentando usar listas como claves de un diccionario
print(powers)

# children = {"von Trapp": ["Johannes", "Rosmarie", "Eleonore"] , "Corleone": ["Sonny", "Fredo", "Michael"]}
# print(children) #imprime 
